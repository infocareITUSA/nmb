        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          ...
          <div className="space-y-2 max-w-3xl">
            ...
            <p className="text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed max-w-[800px] mx-auto">
              Fill out the form below and our team will get back to you as soon as possible to discuss your steel
              fabrication needs.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-8 items-start max-w-6xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitError && (
                <div className="p-4 rounded-md bg-red-50 border border-red-100 flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-red-800">Message Could Not Be Sent</h4>
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="bg-gradient-to-br from-nmb-blue/5 to-nmb-gold/5 rounded-xl p-6 border border-gray-100">
              <h3 className="text-lg font-bold text-nmb-blue mb-4">Why Contact Us?</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <p className="text-gray-600 text-sm">Get expert consultation on your steel fabrication project</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-nmb-blue/10 flex items-center justify-center mt-0.5 mr-3">
                    <span className="text-nmb-blue text-xs font-bold">2</span>
                  </div>
                  <p className="text-gray-600 text-sm">Request a detailed quote for your specific requirements</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-nmb-blue/10 flex items-center justify-center mt-0.5 mr-3">
                    <span className="text-nmb-blue text-xs font-bold">3</span>
                  </div>
                  <p className="text-gray-600 text-sm">Learn more about our services and capabilities</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-nmb-blue/10 flex items-center justify-center mt-0.5 mr-3">
                    <span className="text-nmb-blue text-xs font-bold">4</span>
                  </div>
                  <p className="text-gray-600 text-sm">Schedule a visit to our facility or a meeting with our team</p>
                </li>
              </ul>
            </div>

            <div className="bg-nmb-blue rounded-xl p-6 text-white">
              <h3 className="text-lg font-bold mb-4">Fast Response Guarantee</h3>
              <p className="text-white/80 text-sm mb-4">
                We understand the importance of timely communication. Our team is committed to responding to all
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
              <h3 className="text-lg font-bold text-nmb-blue mb-4">Connect With Us</h3>
              ...
              <div className="flex space-x-4 justify-center">
                ...
                >
                  <svg className="h-5 w-5 text-nmb-blue" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path
                      fillRule="evenodd"
